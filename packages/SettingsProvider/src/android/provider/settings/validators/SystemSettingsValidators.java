...
public class SystemSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(System.LOCKSCREEN_CHARGING_TIME, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(System.NOTIFICATION_SCRIM_ALPHA, new InclusiveIntegerRangeValidator(0, 100));
